...
export const REMOVE_OPTION_PENDING = 'REMOVE_OPTION_PENDING';
export const REMOVE_OPTION_SUCCESS = 'REMOVE_OPTION_SUCCESS';
export const REMOVE_OPTION_FAIL = 'REMOVE_OPTION_FAIL';
...
export const APPROVE_MEMBER_PENDING = 'APPROVE_MEMBER_PENDING';
export const APPROVE_MEMBER_SUCCESS = 'APPROVE_MEMBER_SUCCESS';
export const APPROVE_MEMBER_FAIL = 'APPROVE_MEMBER_FAIL';
export const DECLINE_MEMBER_PENDING = 'DECLINE_MEMBER_PENDING';
export const DECLINE_MEMBER_SUCCESS = 'DECLINE_MEMBER_SUCCESS';
export const DECLINE_MEMBER_FAIL = 'DECLINE_MEMBER_FAIL';
